...
<html>
    <head>       
        ...
        <title>Lawyers | The Law Guide</title>
                      ...
                      <div class="row">    
                        <div class="col-lg-4">
                          <div class="card" style="width: 20rem;">
                            ...
                            <br></center>
                            <img class="card-img-top" src="<?php echo base_url(); ?>/assets/images/law1.png" alt="Card image cap">
                            <div class="card-body">
                        ...
                        <div class="col-lg-4">
                          <div class="card" style="width: 20rem;">
                            <br>
                            <center>
                              <h4 class="card-title">Ryan Mcdonald</h4>
                              <h6 class="card-subtitle mb-2 text-muted">Lawyer</h6>
                            <br>                            
                            <img class="card-img-top" src="<?php echo base_url(); ?>/assets/images/law2.png" alt="Card image cap"></center>
                            <div class="card-body">
                              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            </div>
                          </div>
                        ...
                        <div class="col-lg-4">
                          <div class="card" style="width: 20rem;">
                            <br>
                            <center>
                              <h4 class="card-title">Anna Heartly</h4>
                              <h6 class="card-subtitle mb-2 text-muted">Lawyer</h6>
                            <br>
                            <img class="card-img-top" src="<?php echo base_url(); ?>/assets/images/law5.png" alt="Card image cap"></center>
                            <div class="card-body">
                              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            </div>
                          </div>
                        ...
                        <div class="col-lg-4">
                          <div class="card" style="width: 20rem;">
                            <br>
                            <center>
                              <h4 class="card-title">Christine Green</h4>
                              <h6 class="card-subtitle mb-2 text-muted">Lawyer</h6>
                            <br>
                            <img class="card-img-top" src="<?php echo base_url(); ?>/assets/images/law6.png" alt="Card image cap"></center>
                            <div class="card-body">
                              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            </div>
                          </div>
